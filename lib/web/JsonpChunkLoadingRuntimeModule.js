		...
		return Template.asString([
			...
			withCallback || withLoading
				? Template.asString([
						...
						"",
						`${cst} chunkLoadingGlobal = ${chunkLoadingGlobalExpr} = ${chunkLoadingGlobalExpr} || [];`,
...
/** @type {(compilation: Compilation) => JsonpCompilationPluginHooks} */
JsonpChunkLoadingRuntimeModule.getCompilationHooks =
	Compilation.createHooksRegistry(() => ({
